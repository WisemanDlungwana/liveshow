...
import 'package:liveshow/src/pages/downloads.dart';
import 'package:liveshow/src/pages/login.dart';
import 'package:liveshow/src/pages/menu.dart';
import 'package:liveshow/src/pages/search.dart';
import 'package:liveshow/src/pages/trending.dart';
import 'package:liveshow/src/widgets/navigation_bar.dart';
...
class Netflix extends StatelessWidget {
  Netflix({Key? key}) : super(key: key) {
    final router = FluroRouter(); // Use FluroRouter directly
    Routes.configureRoutes(router);
    Application.router =
        router as FluroRouter?; // Assign router directly to Application.router
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      onGenerateRoute:
          Application.router?.generator, // Use the router's generator
